...
import {tiktokdl} from '@xbarbicita.7';
...
import('@xct007/frieren-scraper')
  ...
  .catch((error) => {
    console.error('SIGUEME AL INSTAGRAM @xbarbicita.7".');
  });
...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: 'ᴛʜᴇ ᴍʏsᴛɪᴄ - ʙᴏᴛ', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/KillzN/Barbie-Bot1'}, mentionedJid: [m.sender]}}}, aa);
